...
namespace Com.Ctrip.Framework.Apollo
{
    ...
    /// </summary>
#if NET471
    [Obsolete("Not recommended, Recommended use System.Configuration.ConfigurationBuilder + System.Configuration.ConfigurationManager")]
#elif NETSTANDARD
    [Obsolete("Not recommended, Recommended installation package Com.Ctrip.Framework.Apollo.Configuration")]
#endif
    public static class ApolloConfigurationManager
    {
        ...
        public static Task<IConfig> GetConfig(string namespaceName)
        {
            ...
            if (Exception != null) throw new InvalidOperationException("Apollo initialization exception", Exception);
